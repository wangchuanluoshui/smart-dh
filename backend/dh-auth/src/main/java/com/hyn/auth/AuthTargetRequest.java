package com.hyn.auth;

import com.hyn.auth.cache.AuthStateRedisCache;
import com.hyn.auth.custom.AuthMyGitlabRequest;
...
@Component
public class AuthTargetRequest {
...
//                        .redirectUri("http://localhost:9001/oauth/baidu/callback")
            ...
            case "github":
                authRequest = new AuthGithubRequest(AuthConfig.builder()
                        .clientId("bccb297e731a709f7a39")
                        .clientSecret("cb8ae7d3f2cc27fe67535cfca22b419777c206da")
                        .redirectUri("http://127.0.0.1:8080/api/oauth/callback/github")
